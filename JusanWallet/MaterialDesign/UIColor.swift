...
extension UIColor {
    ...
    static let secondary = UIColor(red: 30/255, green: 34/255, blue: 38/255, alpha: 1.0); //elements on top the surface

    static let secondaryIncomeVariant = UIColor(red: 32/255, green: 41/255, blue: 36/255, alpha: 1.0); //income card that is on top of the surface
    static let secondaryExpensesVariant = UIColor(red: 35/255, green: 29/255, blue: 29/255, alpha: 1.0); //expenses card that is on top of the surface
    static let onSecondaryIncomeVariant = UIColor(red: 116/255, green: 204/255, blue: 167/255, alpha: 1.0);
    static let onSecondaryExpenseVariant = UIColor(red: 240/255, green: 70/255, blue: 72/255, alpha: 1.0);
...
//    static let Material = MaterialDesign
}
